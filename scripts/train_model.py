...
def configure_arg_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="Max length of context fed into diffusion",
    )
    ...
    parser.add_argument(
        ...
        "--device",
        default="cpu",
        help="Device on which to evaluate the diffusion",
    )
    parser.add_argument(
        "-nd",
        "--num_devices",
    ...
    parser.add_argument(
        ...
        "--schedule",
        default="linear",
        help="Noise schedule for diffusion diffusion",
    )
    parser.add_argument(
        "-df",
        "--diffusion_steps",
...
def main(
    ...
    val_dataset = ConvAI2Dataset(val, name, max_context, max_gen)
